...
export function AnalyticsDashboard() {
  ...
  const weeklyAttendanceData = [
    { day: "Mon", attendance: 85, target: 90 },
    { day: "Tue", attendance: 92, target: 90 },
    { day: "Wed", attendance: 78, target: 90 },
    { day: "Thu", attendance: 88, target: 90 },
    { day: "Fri", attendance: 95, target: 90 },
    { day: "Sat", attendance: 82, target: 90 },
    { day: "Sun", attendance: 0, target: 90 },
  ]
  ...
  const courseAttendanceData = [
    { course: "CS101", attendance: 88, students: 45 },
    { course: "MATH201", attendance: 92, students: 32 },
    { course: "ENG101", attendance: 76, students: 28 },
    { course: "PHYS101", attendance: 84, students: 38 },
    { course: "CHEM101", attendance: 90, students: 35 },
  ]
      ...
      <Tabs defaultValue="overview" className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card>
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Overall Rate</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Daily attendance rates vs target</CardDescription>
              </CardHeader>
              <CardContent>
        ...
        <TabsContent value="courses" className="space-y-6">
          <Card>
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={400}>
                <BarChart data={courseAttendanceData} layout="horizontal">
                  <CartesianGrid strokeDasharray="3 3" />
                  <XAxis type="number" />
                    ...
                    <TableRow key={course.course}>
                      ...
                      <TableCell>
                        <div className="flex items-center gap-2">
                          ...
                          <Progress value={course.attendance} className="w-20 h-2" />
                        </div>
                      </TableCell>
                      <TableCell>
                      ...
                      <TableCell>
                        <Badge
                          variant={
                            course.attendance >= 85 ? "default" : course.attendance >= 70 ? "secondary" : "destructive"
                          }
                        >
                          {course.attendance >= 85 ? "Good" : course.attendance >= 70 ? "Fair" : "Poor"}
                        </Badge>
                      </TableCell>
                    </TableRow>
                  ))}
